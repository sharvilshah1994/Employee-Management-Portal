...
$query1 = "SELECT * FROM fixed_asset_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit details of Fixed assets verification for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
                
            </div>
    <div class="row">
        <form role="form" action="updatefixed_asset_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
        <div class="col-lg-6">
            ...
            <div class="input-group registration-date-time">
                ...
                <input type="text" id="asset_name" name="asset_name" class="form-control" value="<?php echo $row1['asset_name'];?>">
                <br>
                <label>Rate of depreciation</label>
                <input type="text" id="rate_dep" name="rate_dep" class="form-control" value="<?php echo $row1['rate_dep'];?>">
                <br>
                </div>
        <div class="col-lg-6">
                <label>Amount</label>
