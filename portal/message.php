...
$query = "select distinct * from users where username in (select distinct a.to from (select * from message where message.from='$username' )a inner join "
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php
                                                ...
                                                ?>
                                            <a href="sendmessage.php?to=<?php echo $row['id']; ?>" class='btn btn-info' id='sendmessage'>Message</a>
                                            </td>
                                        </tr>
                                    ...
                                    <td id="row">
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <a href='"sendmessage.php?to=<?php echo $row['id']; ?>"' class='btn btn-info' id='sendmessage'>Message</a></td>
                                        </tr>
                                        <?php
