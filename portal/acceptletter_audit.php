...
$query1 = "SELECT * FROM acceptletter_audit WHERE parent_id='$parent_id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Acceptance Letter for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="submitacceptletter_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            if ($result1->num_rows > 0)
            {
                ?>
                <a href="editacceptletter_audit.php?parent_id=<?php echo $parent_id;?>" class="btn btn-info">Edit</a>
            <br>
            <br>
            <?php
            ...
            <?php echo $row1['mode_dispatch'];?><br>
     ...
     if(!empty($row1['edited_by']))
            ...
            <label>Mode of Dispatch</label>
            <input type="text" id="mode_dispatch" name="mode_dispatch" class="form-control">
            <br>
            <label>Remarks</label>
