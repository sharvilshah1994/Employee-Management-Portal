...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add record for <?php echo $type_comm;?> of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="submitcomm_comp.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>&type_comm=<?php echo $type_comm;?>&type_tax=<?php echo $type_tax;?>" enctype="multipart/form-data" method="POST">
