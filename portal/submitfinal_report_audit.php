...
$query1 = "INSERT INTO `final_report_audit`(`parent_id`, `report`, `bill_details`) VALUES "
        . "('$parent_id','$target_file','$bill_details')";

if(!empty($target_file) and !empty($bill_details))
{
