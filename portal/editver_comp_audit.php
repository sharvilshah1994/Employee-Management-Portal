...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit AS Checklist document of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="updatever_comp_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            ...
            while($row1 = mysqli_fetch_assoc($result1))
            {
             ...
             ?>
                ...
                <label>AS Checklist</label><br>
                <input type="file" id="as_checklistnew" name="as_checklistnew" class="form-control"><br>
                <input type="hidden" id="as_checklist" name="as_checklist" class="form-control" value="<?php echo $row1['as_checklist'];?>">
                <?php 
                if(!empty($row1['as_checklist']))
                {
                ?>
                <a href="<?php echo $row1['as_checklist'];?>" >View last uploaded AS Checklist</a>
                <br>
                <?php
                }
                ?>
