...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add details of ROC Compliance and company secreterial audit report for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
        ...
        <div class="col-lg-6">
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of verification</label>
                        <input class="form-control" id="date_verification" type="date" name="date_verification">
            		
            </div>
            </div>
            <br>
            <label>Verification by</label>
            <input type="text" name="verification_by" id="verification_by"  class="form-control">
            <br>
