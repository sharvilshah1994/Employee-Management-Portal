...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Important Board Resolutions of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
        ...
        <div class="col-lg-6">
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of Resolution</label>
                        <input class="form-control" id="date_resolution" type="date" name="date_resolution">
