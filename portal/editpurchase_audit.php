...
$query1 = "SELECT * FROM purchase_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit details of Purchase verification for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
                
            </div>
    <div class="row">
        <form role="form" action="updatepurchase_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
        <div class="col-lg-6">
            ...
            <div class="input-group registration-date-time">
                ...
                <input type="text" name="supplier" id="supplier" class="form-control" value="<?php echo $row1['supplier'];?>">
                <br>
                <label>Voucher Number</label>
                <input type="text" id="voucher_no" name="voucher_no" class="form-control" value="<?php echo $row1['voucher_no'];?>">
                <br>
                <label>Material</label>
                <input type="text" id="material" name="material" class="form-control" value="<?php echo $row1['material'];?>">
                <br>
                </div>
        <div class="col-lg-6">
                <label>Quantity</label>
                <input type="text" id="qty" name="qty" class="form-control" value="<?php echo $row1['qty'];?>">
                <br>
