...
$target_file = $target_dir . basename($_FILES["caro_checklist"]["name"]);
$imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);


 if (move_uploaded_file($_FILES["caro_checklist"]["tmp_name"], $target_file)) {
        echo "The file ". basename( $_FILES["caro_checklist"]["name"]). " has been uploaded.";
    } else {
        echo "Sorry, there was an error uploading your file.";
    }

$query1 = "INSERT INTO `prep_caro_audit`(`parent_id`,  `caro_checklist`) VALUES "
