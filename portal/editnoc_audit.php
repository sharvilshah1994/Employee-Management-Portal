...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit NOC Details for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="updatenoc_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of Receipt</label>
                        <br>
                        <input class="form-control" id="date_receipt" type="date" name="date_receipt" value="<?php echo $row1['date_receipt'];?>">
                        <br>	
            </div>
            </div>
