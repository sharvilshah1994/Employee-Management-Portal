...
$query1 = "INSERT INTO `bank_book_audit`(`parent_id`, `srno`, `date_checking`, `voucher_no`, `account_head`,"
...
if (($conn->query($query1) === TRUE) ) {
    ...
    echo "<script type='text/javascript'> window.location = 'http://$servername/dgsm1/portal/bank_book_audit.php?id=$id&parent_id=$parent_id' </script>";
