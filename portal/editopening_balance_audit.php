...
$query1 = "SELECT * FROM opening_balance_audit WHERE ID='$id' AND parent_id='$parent_id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit details of Opening balance verification for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="updateopening_balance_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
                <?php
                ...
                <input type="text" name="name_account" id="name_account" class="form-control" value="<?php echo $row1['name_account'];?>">
                <br>
                <label>Group</label>
                <input type="text" id="group" name="group" class="form-control" value="<?php echo $row1['group'];?>">
                <br>
