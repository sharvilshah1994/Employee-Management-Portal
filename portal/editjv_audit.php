...
$query1 = "SELECT * FROM jv_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
    ...
    <div class="row">
        <form role="form" action="updatejv_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
        <div class="col-lg-6">
