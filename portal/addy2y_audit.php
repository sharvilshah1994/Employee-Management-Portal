...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add detail of Year to year comparison & reason for that for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="submity2y_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
                ...
                <input type="text" name="acc_head" id="acc_head" class="form-control">
                <br>
                <label>Current year balance amount</label>
            <input type="text" name="cr_balance_amount" id="cr_balance_amount" class="form-control">
                <br>
            <label>Previous year balance amount</label>
            <input type="text" name="pr_balance_amount" id="pr_balance_amount" class="form-control">
            <br>
