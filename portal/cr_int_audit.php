...
$query1 = "SELECT * FROM cr_int_audit WHERE parent_id='$parent_id'";
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form role="form" action="submitcr_int_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            
                <a href="addcr_int_audit.php?id=<?php echo $id; ?>&parent_id=<?php echo $parent_id;?>" class="btn btn-info">Add</a>
            <br>
            <br>
            <table>
                <tr>
            ...
            ?>    
                <tr>
                    ...
                    <td><a href="editcr_int_audit.php?id=<?php echo $row1['ID'];?>&parent_id=<?php echo $row1['parent_id'];?>" class="btn btn-info">Edit</a></td>
                </tr>
                <?php
            }
            ?>
