...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add details of Fixed assets for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
                
            </div>
    <div class="row">
        <form role="form" action="submitfixed_asset_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
        <div class="col-lg-6">
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date</label>
                        <input class="form-control" id="date_checking" type="date" name="date_checking">
                ...
                <input type="text" id="rate_dep" name="rate_dep" class="form-control">
                </div>
        <div class="col-lg-6">
                <label>Amount</label>
