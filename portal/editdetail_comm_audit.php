...
$query1 = "SELECT * FROM detail_comm_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Communication details with <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            {
            ?>
            <form role="form" action="updatedetail_comm_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
                ...
                <input type="text" name="mode_comm" id="mode_comm" class="form-control" value="<?php echo $row1['particulars'];?>">
                <br>
                <div class="form-group registration-date">
            <div class="input-group registration-date-time">
            		<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
            		<label>Date of communication</label>
                        <input class="form-control" id="date_comm" type="date" name="date_comm" value="<?php echo $row1['date_comm'];?>">
        ...
        <div class="col-lg-6">
                ...
                <input type="text" name="by_comm" id="by_comm" class="form-control" value="<?php echo $row1['by_comm'];?>">
