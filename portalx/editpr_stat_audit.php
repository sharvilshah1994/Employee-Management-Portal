...
$query1 = "SELECT * FROM pr_stat_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="updatepr_stat_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
