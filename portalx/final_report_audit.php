...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Final Audit report of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="submitfinal_report_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            if ($result1->num_rows > 0)
            {
               ?>
            <a href="editfinal_report_audit.php?id=<?php echo $id; ?>&parent_id=<?php echo $parent_id;?>" class="btn btn-info">Edit</a>
            <br>
            <br>
            <?php
            ...
            ?>
                <label>Final audit report-</label>
                <a href="<?php echo $row1['report']?>">View report</a>&nbsp;(Copy to be kept in file)
                <br>
                  
            <label>Bill details-</label>
            <br>
            <?php echo $row1['bill_details'];?><br>            
            <?php
            }
            }
            else
            ...
            <br>
            <label>Bill details</label>
            <textarea id="bill_details" name="bill_details" class="form-control"></textarea>
            <br>
