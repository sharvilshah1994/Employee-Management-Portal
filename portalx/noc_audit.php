...
$query1 = "SELECT * FROM noc_audit WHERE parent_id='$parent_id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">NOC for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="submitnoc_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            if ($result1->num_rows > 0)
            {
                ?>
                <a href="editnoc_audit.php?id=<?php echo $id; ?>&parent_id=<?php echo $parent_id;?>" class="btn btn-info">Edit</a>
            <br>
            <br>
            <?php
            ...
            ?>    
                <label>NOC-</label>
                <a href="<?php echo $row1['letter'];?>">View NOC</a>&nbsp;(Copy to be kept in file)
                <br>
                <label>Date of Dispatch-</label>
                <?php echo $row1['date_dispatch'];?><br>            
           
            <label>Date of Receipt-</label>
            <?php echo $row1['date_receipt'];?><br>            
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of Dispatch</label>
                        <input class="form-control" id="date_dispatch" type="date" name="date_dispatch">
            ...
            <div class="input-group registration-date-time">
            		<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
            		<label>Date of Receipt</label>
                        <input class="form-control" id="date_receipt" type="date" name="date_receipt">
