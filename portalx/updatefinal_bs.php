...
$sql = "UPDATE `final_bs` SET `srno`='$srno',`particulars`='$particulars',`remarks`='$remarks',"
        . "`verification`='$verification',`compliance`='$compliance' WHERE `parent_id`='$parent_id' AND ID='$id'";
