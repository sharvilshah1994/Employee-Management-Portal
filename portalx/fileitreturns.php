                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="insertit_returns.php?ID=<?php echo $row1['ID'];?>" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group">b)
                                            ...
                                            <input id="checkbox-proof16" type="checkbox">
                                        ...
                                        <div id="proof16" style="display:none">
                                            ...
                                            <input type="file" name="proof_16" id="proof_16">
                                        </div>
                                                </td>
                                                <td>
                                        <div id="proof16a" style="display:none">
                                            <label>Please upload Form No. 16-A:</label>
                                            <input type="file" name="proof_16a" id="proof_16a">
                                        </div>
                                                </td>
                                                <td>
                                ...
                                <div id="rent" style="display:none">
                                    <table>
                                        <tr>
                                            ...
                                            <textarea name="rent_address" id="rent_address"></textarea>
                                            </td>
                                            <td>
                                            <label>Yearly Income from rental property (INR):</label>
                                            <input type="text" name="rent_income" id="rent_income">
                                            </td>
                                            </tr>
                                    </table>
                                        </div>
                                ...
                                <div class="form-group">e)
                                    ...
                                    <div id="agriculture" style="display: none">
                                        <table>
                                            ...
                                            <input type="text" name="agriculture_income" id="agriculture_income">
                                                </td>
                                                <td>
                                            <label>Upload Profit and Loss Statement:</label>
                                            <input type="file" name="agriculture_pl_statement" id="agriculture_pl_statement">
                                                </td>
                                            </tr>
                                        </table>
                                    </div><hr>
                                ...
                                <table>
                                        ...
                                        <div id="capital_account" style="display:none">
                                            ...
                                            <input type="file" name="capitalaccount" id="capitalaccount">
                                        </div>
                                                </td>
                                                <td>
                                        <div id="pl_statement" style="display:none">
                                            <label>Upload Profit & Loss Statement:</label>
                                            <input type="file" name="plstatement" id="plstatement">
                                        </div>
                                                </td>
                                               <td>
                                        ...
                                        <div id="capital_gains" style="display: none">
                                            ...
                                            <input type="file" id="capitalgains" name="capitalgains">
                                                    ...
                                                    <td style="width: 50%">
                                                        ...
                                                        <input type="text" name="capital_long" id="capital_long">
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <div id="interest" style="display: none">
                                            ...
                                            <input type="file" name="interest_account" id="interest_account">
                                                    </td>
                                                    <td style="width: 50%">
                                                        <label>Upload Dividend Account Excel Sheet:</label>
                                                        <input type="file" name="dividend_account" id="dividend_account">
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <div id="relaxation" style="display: none">
                                            ...
                                            <input type="text" name="dedu_ppf" id="dedu_ppf"><br><br>
                                            <label>Mediclaim:&nbsp;</label>
                                            <input type="text" name="dedu_mediclaim" id="dedu_mediclaim"><br><br>
                                            <label>Insurance Premium:&nbsp;</label>
                                            <input type="text" name="dedu_insurance" id="dedu_insurance"><br><br>
                                            <label>Kids Tuition:&nbsp;</label>
                                            <input type="text" name="dedu_tuition" id="dedu_tuition"><br><br>
                                            <label>Property Loan EMI:&nbsp;</label>
                                            <input type="text" name="dedu_loan" id="dedu_loan"><br><br>
                                            <label>Donation:&nbsp;</label>
                                            <input type="text" name="dedu_donation" id="dedu_donation"><br><br>
                                            <label>Other:&nbsp;</label>
                                            <input type="text" name="dedu_other" id="dedu_other"><br><br>
                                        </div>
                                        <hr>
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="file" name="draft_soi" id="draft_soi">                                                        
                                                    </td>
                                                    <td>
                                                        <label>Upload Final Statement of Income:</label>
                                                        <input type="file" name="final_soi" id="final_soi">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input class="form-control" type="text" name="soi-prep" id="soi-prep" placeholder="Name of person who prepared SOI">
                                                    </td>
                                                    <td>
                                        ...
                                        <div id="return" style="display: none">
                                            ...
                                            <input type="file" name="uploaded_return" id="uploaded_return">
                                                    </td>
                                                    <td>
                                            ...
                                            <div id="audit" style="display:none">
                                                ...
                                                <input type="file" name="tax_audit" id="tax_audit">
                                                        </td>
                                                        <td>
                                                <label>Upload Statutory Audit Report:</label>
                                                <input type="file" name="statutory_audit" id="statutory_audit">
                                                        </td>
                                                        <td>
                                                <label>Any Other Audit Report:</label>
                                                <input type="file" name="other_audit" id="other_audit">
                                                        </td>
                                                </tr>
                                                </table>
                                            </div>
                                        ...
                                        <div class="form-group">m)
                                            ...
                                            <div id="physical" style="display: none">
                                                ...
                                                <div id="status" style="display:none">
                                                    ...
                                                    <input type="file" name="speed_post" id="speed_post">
                                                </div>
                                                        </td>
                                                        <td>
                                                <div id="status1" style="display:none">
                                                    <label>Upload ITR Receipt:</label>
                                                    <input type="file" name="itr_receipt" id="itr_receipt">
                                                </div>
                                                        </td>
                                                    </tr></table>
                                            </div>
