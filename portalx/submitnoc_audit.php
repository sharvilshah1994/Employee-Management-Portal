...
$date_receipt = $_REQUEST['date_dispatch'];
...
$query1 = "INSERT INTO `noc_audit`(`parent_id`,`date_dispatch`,`date_receipt`, `letter`, `verification`,`time_edit`,`edited_by`) VALUES "
        . "('$parent_id','$date_dispatch','$date_receipt','$target_file','$verification','$time','$uname')";

if(!empty($date_receipt) and !empty($target_file) and !empty($verification) and !empty($date_dispatch))
{
