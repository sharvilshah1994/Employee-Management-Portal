...
$query1 = "SELECT * FROM less_bank_recon WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Less record of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            {
            ?>
            <form role="form" action="updateless_bank_recon.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
                <br>
                <label>Sr No</label>
            ...
            <div class="input-group registration-date-time">
            		<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
            		<label>Subsequent date of clearing</label>
                        <input class="form-control" id="date_clearing" type="date" name="date_clearing" value="<?php echo $row1['date_clearing'];?>">
            		
            </div>
            </div>
                <br>
                <label>Amount</label>
                <input type="text" name="amount" id="amount" class="form-control" value="<?php echo $row1['amount'];?>">       
                <br>
