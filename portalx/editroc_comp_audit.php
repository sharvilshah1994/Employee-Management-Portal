...
$query1 = "SELECT * FROM roc_comp_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit details of ROC Compliance and company secreterial audit report for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            {
            ?>
            <form role="form" action="updateroc_comp_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of verification</label>
                        <input class="form-control" id="date_verification" type="date" name="date_verification" value="<?php echo $row1['date_verification'];?>">
            		
            </div>
            </div>
            
            <label>Verification by</label>
            <input type="text" name="verification_by" id="verification_by"  class="form-control" value="<?php echo $row1['verification_by'];?>">
            <br>
