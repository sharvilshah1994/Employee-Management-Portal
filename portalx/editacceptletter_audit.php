...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Acceptance Letter Details for <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="updateacceptletter_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of Dispatch</label>
                        <br>
                        <input class="form-control" id="date_dispatch" type="date" name="date_dispatch" value="<?php echo $row1['date_dispatch'];?>">
                        <br>	
            </div>
            </div>
                
                <label>Acceptance Letter</label><br>
                ...
                ?>
                <br>
                <label>Mode of Dispatch</label><br>
            <input type="text" id="mode_dispatch" name="mode_dispatch" class="form-control" value="<?php echo $row1['mode_dispatch'];?>"><br>
