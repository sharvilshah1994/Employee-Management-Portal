...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Management Representation Letter of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form role="form" action="submitmgt_rep_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
            <?php 
            if ($result1->num_rows > 0)
            {
               ?>
            <a href="editmgt_rep_audit.php?id=<?php echo $id; ?>&parent_id=<?php echo $parent_id;?>" class="btn btn-info">Edit</a>
            <br>
            <br>
            <?php
            ...
            ?>
                <label>Scanned copy of letter-</label>
                <a href="<?php echo $row1['letter']?>">View letter</a>&nbsp;(Copy to be kept in file)
                <br>
                  
            <label>Standard draft management letter-</label>
            <a href="<?php echo $row1['std_letter']?>">View standard letter</a>&nbsp;(Copy to be kept in file)
            <?php
            }
            }
            else
            ...
            <br>
            <label>Standard draft management letter</label>
            <input type="file" id="std_letter" name="std_letter" class="form-control">
            <br>
