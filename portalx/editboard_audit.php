...
$query1 = "SELECT * FROM board_audit WHERE parent_id='$parent_id' AND ID='$id'";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Important Board Resolutions of <span style="color: crimson"><?php echo $row['cl_name'];?></span></h1>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            {
            ?>
            <form role="form" action="updateboard_audit.php?id=<?php echo $id;?>&parent_id=<?php echo $parent_id; ?>" enctype="multipart/form-data" method="POST">
                <br>
                <label>Sr No</label>
            ...
            <div class="input-group registration-date-time">
            		...
            		<label>Date of Resolution</label>
                        <input class="form-control" id="date_resolution" type="date" name="date_resolution" value="<?php echo $row1['date_resolution'];?>">
